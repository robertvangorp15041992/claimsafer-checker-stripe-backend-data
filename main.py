...
async def health_check():
    ...
    return {
        ...
        "version": "2.5-AUTHENTICATION-SYSTEM-ENABLED"
    }
...
def test_auth():
    ...
    return {"message": "Authentication system is working!", "version": "2.5-AUTHENTICATION-SYSTEM-ENABLED"}
...
async def search_by_ingredient(
    ...
    try:
        ...
        if is_camu_camu and any("vitamin c" in c.lower() for c in processed_claims):
            country_dosage_text = "≥ 12 mg vitamin C per serving"
